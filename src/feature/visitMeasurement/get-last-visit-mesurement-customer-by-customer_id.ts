...
const getLastVisitMeasurmentCustomerByCustomerIdHandler: ApiHandler = async ({ request, response }) => {
...
export default getLastVisitMeasurmentCustomerByCustomerIdHandler;
