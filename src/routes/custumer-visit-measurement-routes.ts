...
import createVisitMeasurmentCustumerHandler from '../feature/visitMeasurement/create-visit-mesurement-custumer';
...
visitMeasurementRouter.post('/', createRoute(createVisitMeasurmentCustumerHandler));
